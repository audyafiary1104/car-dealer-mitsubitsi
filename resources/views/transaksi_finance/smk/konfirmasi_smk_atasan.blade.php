            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <a href="#" data-toggle="modal" data-target="#lempar_smk_ats"><i class="fa fa-mail-reply-all fa-lg" style="text-shadow:1px 1px 3px black;color:blue" data-toggle="tooltip" title="Lempar"></i></a>
                        </td>
                    </tr>
